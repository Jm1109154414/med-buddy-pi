      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Pastillero inteligente con Raspberry Pi. Nunca olvides tomar tus medicamentos.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-16">
          {[
            { icon: Bell, title: "Notificaciones", desc: "Alertas push cuando es hora de tu medicamento" },
            { icon: BarChart3, title: "Reportes", desc: "Seguimiento de adherencia y estadísticas" },
            { icon: Shield, title: "Seguro", desc: "Tus datos protegidos con cifrado" }
          ].map((feature, i) => (
